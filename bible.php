...
<html>
<head>
	<title style = "margi-bottom = 20px;">King James Version Bible</title>
...
<body>
	...
	<div class='navbar-fixed-top'>
		<div class='navbar-inner'>
			<div class='nav'>
				<label style = "font-family: Georgia;font-size: 35;margin-left: 53;margin-bottom: 9;margin-top: 16;">King James Version Bible</label>
...
<div class='container'>
	<div class='row'>
		...
		<div style='margin-top:150px'>
			<div class = "box_book" style = "margin-bottom: 32;">
			...
			<div id="verse_text" style='margin-top:70px;font-size:30px'>
					<?php echo '<center>'.$defaultVerseText[1]['verse_text']."<br/></center><p style = 'margin-left: 701px;
margin-top: 82px;'>".$defaultVerseText[1]['book_name'].' '.$defaultVerseText[0]['chapter_number'].':'.$defaultVerseText[0]['verse_number'].'</p>'; ?>
			</div>
